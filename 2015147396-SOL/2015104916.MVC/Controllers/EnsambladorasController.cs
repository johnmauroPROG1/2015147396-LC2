...
namespace _2015104916.MVC.Controllers
{
    public class EnsambladorasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idEnsambladora,Nombre")] Ensambladora ensambladora)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idEnsambladora,Nombre")] Ensambladora ensambladora)
        {
            if (ModelState.IsValid)
            {
