...
namespace _2015104916.MVC.Controllers
{
    public class ParabrisasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idParabrisas,NumSerie")] Parabrisas parabrisas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idParabrisas,NumSerie")] Parabrisas parabrisas)
        {
            if (ModelState.IsValid)
            {
