...
namespace _2015104916.MVC.Controllers
{
    public class LlantasController : Controller
    {
        ...
        {
            ViewBag.idCarro = new SelectList(db.Buses, "idCarro", "NumSerie");
        ...
        public ActionResult Create([Bind(Include = "LlantaId,NumSerie,idCarro")] Llanta llanta)
        {
            ...
            ViewBag.idCarro = new SelectList(db.Buses, "idCarro", "NumSerie",llanta.idCarro);
            return View(llanta);
        }
        ...
        public ActionResult Edit(int? id)
        {
            ...
            ViewBag.idCarro = new SelectList(db.Carros, "idCarro", "NumSerieMotor", llanta.idCarro);
            return View(llanta);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "LlantaId,NumSerie,idCarro")] Llanta llanta)
        {
            if (ModelState.IsValid)
            {
