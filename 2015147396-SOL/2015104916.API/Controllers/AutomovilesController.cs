...
namespace _2015104916.API.Controllers
{
    public class AutomovilesController : ApiController
    {
        ...
        public IHttpActionResult PostAutomovil(Automovil automovil)
        {
            ...
            {
                if (AutomovilExists(automovil.idCarro))
                {
                    return Conflict();
                }
                else
            ...
            return CreatedAtRoute("DefaultApi", new { id = automovil.idCarro }, automovil);
        }
        ...
        {
            return db.Carros.Count(e => e.idCarro == id) > 0;
        }
    }
}